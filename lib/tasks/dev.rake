...
task({ :sample_data => :environment }) do
  ...
  # Create crawls and stops
    ...
    stops = stops.push(:crawl_name => "Sculptures and Statues", :order_number => 2, :location_name => "The Chicago Picasso", :recommendation => "The Chicago Picasso is a monumental sculpture by Pablo Picasso. Unveiled in 1967, it was the first monumental sculpture by the artist in the United States. Its abstract form has become a symbol of Chicago's public art scene.")
    stops = stops.push(:crawl_name => "Sculptures and Statues", :order_number => 3, :location_name => "Flamingo", :recommendation => "Designed by American artist Alexander Calder, Flamingo is a striking red sculpture located in the Federal Plaza in the heart of the Loop. Its vibrant color and abstract form make it a prominent feature of the city's skyline.")
